 ...
 */
class ComInterestsControllerInterests extends ComMediumControllerDefault
{
    /**
     * Constructor.
     *
    ...
    /**
     * Sets the value of lastChanger to the last person who opened or closed a interests.
     *
