 ...
 */
class ComClassesControllerToolbarClasses extends ComMediumControllerToolbarDefault
{
    /**
    ...
    protected function _commandEnable($command)
    {
        ...
        $label = AnTranslator::_('COM-CLASSES-ACTION-'.strtoupper($entity->enabled ? 'disable' : 'enable'));
