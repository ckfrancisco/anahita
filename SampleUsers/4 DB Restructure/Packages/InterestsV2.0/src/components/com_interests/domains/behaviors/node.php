 ...
 * set the interests open_status_change_by to null.
 *
 * @category   Anahita
 *
 ...
 */
class ComInterestsDomainBehaviorNode extends LibBaseDomainBehaviorNode
{
    /**
     * (non-PHPdoc).
     *
    ...
    protected function _afterRepositoryDeletenodes(KCommandContext $context)
    {
        ...
        $this->_getRepositoryForTable('interests_interests')
