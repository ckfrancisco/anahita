 ...
 */
class ComInterestsControllerToolbarInterests extends ComMediumControllerToolbarDefault
{
    /**
    ...
    protected function _commandEnable($command)
    {
        ...
        $label = AnTranslator::_('COM-INTERESTS-ACTION-'.strtoupper($entity->enabled ? 'disable' : 'enable'));
