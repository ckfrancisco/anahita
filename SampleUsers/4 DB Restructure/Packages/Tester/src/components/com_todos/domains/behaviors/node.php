 ...
 * set the tester open_status_change_by to null.
 *
 * @category   Anahita
 *
 ...
 */
class ComTesterDomainBehaviorNode extends LibBaseDomainBehaviorNode
{
    /**
     * (non-PHPdoc).
     *
    ...
    protected function _afterRepositoryDeletenodes(KCommandContext $context)
    {
        ...
        $this->_getRepositoryForTable('tester_tester')
