 ...
 */
class ComTesterControllerToolbarTester extends ComMediumControllerToolbarDefault
{
    /**
    ...
    protected function _commandEnable($command)
    {
        ...
        $label = AnTranslator::_('COM-TESTER-ACTION-'.strtoupper($entity->enabled ? 'disable' : 'enable'));
