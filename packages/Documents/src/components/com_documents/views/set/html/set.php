...
<div class="an-entity an-documents-set editable" data-url="<?= @route($set->getURL()) ?>">
<? else : ?>
<div class="an-entity an-documents-set">
<? endif; ?>
...
<div id="set-documents" class="an-entities" data-url="<?= @route($set->getURL()) ?>">
