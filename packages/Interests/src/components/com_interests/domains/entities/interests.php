 ...
 */
class ComInterestsDomainEntityInterests extends ComMediumDomainEntityMedium
{
    /*
     * Priorities values
     */
    ...
    {
        $config->append(array(
            'resources' => array('interests_interests'),
            'attributes' => array(
