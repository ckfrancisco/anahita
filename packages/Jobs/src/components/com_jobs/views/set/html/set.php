...
<div class="an-entity an-jobs-set editable" data-url="<?= @route($set->getURL()) ?>">
<? else : ?>
<div class="an-entity an-jobs-set">
<? endif; ?>
...
<div id="set-jobs" class="an-entities" data-url="<?= @route($set->getURL()) ?>">
