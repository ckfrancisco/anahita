...
<data name="title">
	<?= sprintf(@text('COM-JOBS-STORY-NEW-SET'),  @name($subject), @route($object->getURL())) ?>
</data>
...
<data name="body">
	...
	<div class="media-grid">
		<? $jobs = $object->jobs->order('jobSets.ordering')->limit(10)->fetchSet(); ?>
	...
	<div class="entity-meta">
		<?= sprintf(@text('COM-JOBS-SET-META-JOBS'), $object->getJobCount()) ?>
	</div>
</data>
