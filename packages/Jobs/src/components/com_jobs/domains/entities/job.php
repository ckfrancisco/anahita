 ...
 */
class ComJobsDomainEntityJob extends ComMediumDomainEntityMedium
{
    /**
     * Default Image.
     */
    ...
    /**
     * Synchronizes the job sets.
     *
     * @return unknown_type
     */
    public function delete()
    {
        //keep the jobs set to use
    ...
    /**
     * Delete the job from all the sets.
     *
     * KCommandContext $context Context
     */
