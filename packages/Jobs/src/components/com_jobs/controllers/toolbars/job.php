 ...
 */
class ComJobsControllerToolbarJob extends ComMediumControllerToolbarDefault
{
    /**
    ...
    public function addToolbarCommands()
    {
        ...
        if ($entity->owner->authorize('administration')) {
            $this->addCommand('OpenSetSelector', AnTranslator::_('COM-JOBS-ACTION-ADD-TO-SET'))
                ->getCommand('OpenSetSelector')
                ->href(route('option=com_jobs&view=sets&layout=selector&oid='.$entity->owner->id.'&job_id='.$entity->id))
