...
CREATE TABLE `#__classes_classes` (
  ...
  `open_status_change_by` bigint(11) DEFAULT NULL,*//*--Jerdon Helgeson--*/
  PRIMARY KEY (`classes_classes_id`),
  UNIQUE KEY `node_id` (`node_id`)
) ENGINE=InnoDB;

INSERT INTO #__migrator_versions (`version`,`component`) VALUES(4, 'classes') ON DUPLICATE KEY UPDATE `version` = 4; /*--Jerdon Helgeson--*/
